    ...
    <BrowserRouter>
      ...
      <header className="pt-[2mm] pb-[2mm] fixed top-0 w-[calc(100%-10mm)] md:w-[calc(100%-(100%-45rem)+1px)] bg-gray-900">
        <div className="flex justify-between">
          ...
          <div className="flex">
            <NavLink to="/post">
              <svg viewBox="0 0 24 24" fill="none" className="rounded w-[12mm] h-[12mm] sm:w-[16mm] sm:h-[16mm] stroke-zinger hover:stroke-zinger-alt">
      ...
      <footer class="flex justify-between dark:text-zinger">
      <p>&copy; tom baker</p>
      <div class="flex">
